"""
Django settings for quickBooksApi project.
...
SECRET_KEY = 'django-insecure-37orse8l091hk2-)f03md&$592v_^9)uja*ugt%wx=4(=y57ee'
...
ROOT_URLCONF = 'quickBooksApi.urls'
...
WSGI_APPLICATION = 'quickBooksApi.wsgi.application'
